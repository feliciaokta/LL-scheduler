...
it("loads data, books an interview and reduces the spots remaining for the first day by 1", async () => {
  ...
  const appointment = getAllByTestId(container, "appointment")[0]; // first elm of appts array
  
  // console.log("1. ", prettyDOM(container));
  // console.log("2. ", prettyDOM(appointments));
  // console.log("3. ", prettyDOM(appointment));
